...
declare_id!("F3ScEVNvgro9mioY4Yiez4BRpdkswV8Cjgbny54LQ4vG");
...
#[program]
pub mod ico {
    pub const ICO_MINT_ADDRESS: &str = "7cqbAqHubJJZ5XUcA2bBgCpioAbv6zTNvqXHe6MBHST9";
    pub const LAMPORTS_PER_TOKEN: u64 = 5_000_000; // 0.001 SOL in lamports
